...
void Collider::Render()
{
    ...
    Vec2 point = (center - Vec2(box.x, box.y)).GetRotated(associated.angleDeg / (180 / M_PI)) + Camera::pos - center;
    points[0] = {(int)point.x, (int)point.y};
    points[4] = {(int)point.x, (int)point.y};

    point = (center - Vec2(box.x + box.w, box.y)).GetRotated(associated.angleDeg / (180 / M_PI)) + Camera::pos - center;
    points[1] = {(int)point.x, (int)point.y};

    point = (center - Vec2(box.x + box.w, box.y + box.h)).GetRotated(associated.angleDeg / (180 / M_PI)) + Camera::pos - center;
    points[2] = {(int)point.x, (int)point.y};

    point = (center - Vec2(box.x, box.y + box.h)).GetRotated(associated.angleDeg / (180 / M_PI)) + Camera::pos - center;
